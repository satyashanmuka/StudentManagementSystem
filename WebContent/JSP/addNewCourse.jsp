...
function validate()
{
	var courseNumber= document.f2.courseNumber.value;
	var courseName= document.f2.courseName.value;
	var instructor= document.f2.instructorName.value;
...
<div id="content">
	...
	<form name ="f2" method =post action="<%=request.getContextPath() %>/MyDataServlet" onsubmit="return validate()">
	 ...
	 <input type= "hidden" name="operation" value="storeCourse">
